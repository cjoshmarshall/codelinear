...
export default function Navbar() {
  return (
    <nav className="px-6 sm:px-0 backdrop-blur-[5px] fixed z-50 flex w-full sm:w-148 lg:w-179 items-center sm:place-self-center justify-between mt-8 bg-[#2F2F2FB2] sm:rounded-lg p-2.5">
